...
from ansible_callback import ResultCallback2, ResultCallback
import pathlib
import os
...
class BaseAnsible():
    def __init__(self,
        ...
        # 实例化回调插件对象
        self.results_callback = ResultCallback2()
...
if __name__ == '__main__':
    ...
    hosts = os.path.join(BASE_DIR, "hosts/host")
    print(hosts)
    ansible2 = BaseAnsible(inventory=hosts, connection='smart')
    ansible2.run(hosts="test", module="shell", args='ps -ef |grep zabbix')
    #
    # # 执行 ad-hoc
    # ansible2.run()
    #
